[Link para página original no Confluence](https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/198410630)

- [Por que é necessário tratarmos a Idempotência do POST/PATCH?](https://openfinancebrasil.atlassian.net/wiki/spaces/DraftOF/pages/177242163/Idempot+ncia+-+v1.0.0-beta.1+-+Pagamentos+Autom+ticos#Por-que-%C3%A9-necess%C3%A1rio-tratarmos-a-Idempot%C3%AAncia-do-POST/PATCH?)
- [Como mitigarmos esse risco?](https://openfinancebrasil.atlassian.net/wiki/spaces/DraftOF/pages/177242163/Idempot+ncia+-+v1.0.0-beta.1+-+Pagamentos+Autom+ticos#Como-mitigarmos-esse-risco?)

    - [Conjunto inicial de regras propostas na aplicação da idempotencia:](https://openfinancebrasil.atlassian.net/wiki/spaces/DraftOF/pages/177242163/Idempot+ncia+-+v1.0.0-beta.1+-+Pagamentos+Autom+ticos#Conjunto-inicial-de-regras-propostas-na-aplica%C3%A7%C3%A3o-da-idempotencia:)
    - [Cenários de uso de idempotência](https://openfinancebrasil.atlassian.net/wiki/spaces/DraftOF/pages/177242163/Idempot+ncia+-+v1.0.0-beta.1+-+Pagamentos+Autom+ticos#Cen%C3%A1rios-de-uso-de-idempot%C3%AAncia)
